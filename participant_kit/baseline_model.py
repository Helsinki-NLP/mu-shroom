...
def tokenize_and_map_labels(examples, tokenizer):
    ...
    for batch_idx in range(len(offset_mappings)):
        ...
        print("offset_mapping:", len(offset_mapping))
...
def train_model(test_lang, data_path, output_dir):
    ...
    if test_lang is not None:
        ...
        data_files = {
            'train': [f'{data_path}/mushroom.{lang}-val.v2.jsonl' for lang in LANGS],
            'validation': f'{data_path}/mushroom.en-val.v2.jsonl'
        }        
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_lang', type=str, default=None)
